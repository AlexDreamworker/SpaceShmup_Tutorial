...
{
    // Траектория движения вычисляется путем линейной интерполяции кривой Безье по более чем двум точкам
    ...
    public override void Move() 
    {
        ...
        if (u > 1) 
        {
            // Этот экземляр Enemy_3 завершил свой жизненный цикл
