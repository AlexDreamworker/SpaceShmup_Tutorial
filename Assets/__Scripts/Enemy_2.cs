...
public class Enemy_2 : Enemy
{
    ...
    // Enemy_2 использует линейную интерполяцию между двумя точками, изменяя результат по синусойде
    public Vector3 p0;
    public Vector3 p1;
    ...
    public override void Move()
    {
        ...
        // Скорректировать U, добавляем значение кривой, изменяющейся по синусойде
