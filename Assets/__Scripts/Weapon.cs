...
public class Weapon : MonoBehaviour
{
    ...
    public float lastShotLime; // Время последнего выстрела
    ...
    public void SetType(WeaponType wt) 
    {
        ...
        lastShotLime = 0; // Сразу после установки _type можно выстрелить
    }
    ...
    public void Fire() 
    {
        ...
        if (Time.time - lastShotLime < def.delayBetweenShots) 
        {
            return;
        }
        Projectile p;
        ...
        switch(type) 
        {
            ...
            case WeaponType.spread:
                ...
                p.rigid.velocity = vel;
                p = MakeProjectile(); // Снаряд, летящий летящий вправо
